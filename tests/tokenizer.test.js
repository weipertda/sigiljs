...
describe('tokenizer', () => {
  ...
  it('handles strings and numbers', () => {
    ...
    expect(tokens[1]).toMatchObject({ kind: 'number literal', value: 42 })
  })
  ...
  it('handles booleans and null', () => {
    ...
    expect(tokens[1]).toMatchObject({ kind: 'boolean literal', value: false })
    expect(tokens[2]).toMatchObject({ kind: 'null literal', value: null })
  })
